export const en = {
  common: {
    ...
    terms: 'Terms ',
    help: 'Help Center',
    optionalNotice: 'Optional — you can add this to your profile ',
  },
  step1: {
    stepInfo: 'Step 1 of 6 · Personal data',
  ...
  login: {
    ...
    staffRegister: 'Register an account',
    isKol: 'KOL / influencer?',
    kolRegister: 'Register as a KOL',
    reqEmail: 'Email is required',
