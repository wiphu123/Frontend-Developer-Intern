...
export default function HeroSection({ heroTag, heroSubtitle, footerCopyright }: HeroSectionProps) {
  ...
  return (
    <div className="w-full h-screen xl:h-full flex flex-col justify-between items-center xl:items-start p-6 sm:p-8 xl:pt-48 xl:p-16 bg-white relative overflow-y-auto xl:overflow-hidden">
      ...
      {/* Content Box หลัก */}
      <div className="my-auto flex flex-col items-center xl:items-start text-center xl:text-left z-10 w-full max-w-sm xl:max-w-md mx-auto xl:mx-0 py-2">
        
        {/* Card Visual Hero Graphic */}
        <div className="relative w-[200px] sm:w-[240px] xl:w-[300px] mx-auto xl:ml-[100px] mb-4 sm:mb-6">
        ...
        <div className="flex flex-col items-center xl:items-start text-center xl:text-left w-full z-10 relative">
          ...
          {/* ใช้ whitespace-nowrap ครอบ work work. เพื่อไม่ให้คำถูกตัดแยกบรรทัด และให้ขึ้นบรรทัดใหม่หลัง creator เฉพาะจอมือถือเล็กๆ */}
          <h1 className="text-xl sm:text-2xl xl:text-[42px] font-black text-slate-900 leading-[1.15] tracking-tight mb-1.5 sm:mb-2">
            Make creator <br className="block lg:hidden" />
            <span className="whitespace-nowrap">
              work <span className="text-indigo-600">work.</span>
            </span>
          </h1>
          
          {/* เพิ่ม whitespace-nowrap เพื่อให้ข้อความอยู่บรรทัดเดียวกันทั้งหมด */}
          <p className="text-slate-400 text-[11px] xl:text-[13px] font-normal whitespace-nowrap">
            {heroSubtitle}
          </p>
        </div>
